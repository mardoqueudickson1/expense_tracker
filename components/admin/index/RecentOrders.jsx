...
const RecentOrders = () => {
  return (
    <div className='w-full col-span-1 relative lg:h-[66vh] h-[50vh] m-auto p-4 border rounded-lg bg-white overflow-scroll'>
      <h1>Novos Membros</h1>
      <ul>
        {data.map((order, id) => (
          <li
          ...
          >
            ...
            <div className='pl-4'>
              ...
              <p className='text-gray-400 text-sm'>{order.name.first}@gmail.com</p>
            </div>
