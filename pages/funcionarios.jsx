...
export default function Table() {
  ...
  const filteredData = funcionarios.filter((item) => item.nome.toLowerCase().includes(search.toLowerCase()));
                ...
                <div className="flex justify-between py-3 lg:mx-[1rem]">
                    ...
                    <div className="flex items-center space-x-2 gap-5 ">
                        <div className="relative gap-5 ">
                            ...
                            <button onClick={downloadPDF} className="relative ml-3 z-0 inline-flex text-sm rounded-md shadow-sm focus:ring-accent-500 focus:border-accent-500 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1">
                                <span className="relative inline-flex items-center px-3 py-3 space-x-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-md sm:py-2">
